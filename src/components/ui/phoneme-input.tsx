...
export default function PhonemeInput({
  ...
  }, [gaWord, value, isGenerating, lastGeneratedFor])
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="text-xs text-gray-500">
        {gaWord.trim() ? (
          <>
            Phoneme will be auto-generated when you type the Ga word. 
            Click <Wand2 className="inline h-3 w-3 mx-1" /> to regenerate.
          </>
        ) : (
